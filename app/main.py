...
class CarWashStation:
    def __init__(
            self, distance_from_city_center: bool, clean_power: int,
            average_rating: bool , count_of_ratings: int
    ) -> None:
    ...
    def serve_cars(self, cars_list: list) -> None:
        total_income = 0.0
    ...
    def rate_service(self, new_rating: bool) -> None:
